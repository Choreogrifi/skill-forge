---
name: update-document-wf
description: Updates specific sections of an existing document based on user instructions. Presents a diff of all proposed changes for approval before writing. Activated by document-writer-wf or invoke directly to revise any document.
metadata:
  skill-type: workflow
  version: "1.0"
