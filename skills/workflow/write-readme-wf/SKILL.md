---
name: write-readme-wf
description: Drafts a production-quality, SEO-optimised Git README.md following the 2026 best-layout standard. Confirms file location with the user before writing. Activated by document-writer-wf or invoke directly for any README creation task.
metadata:
  skill-type: workflow
  version: "1.0"
...
Collect the following fields. If called from `document-writer-wf`, the subject is already known — skip that question and ask only for what is missing:
