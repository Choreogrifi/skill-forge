---
name: review-document-wf
description: Reviews any document against structure, clarity, completeness, and discoverability standards. Returns a scored report with prioritised improvement recommendations. Activated by document-writer-wf or invoke directly to review any markdown or text document.
metadata:
  skill-type: workflow
  version: "1.0"
