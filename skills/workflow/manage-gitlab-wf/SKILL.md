---
name: manage-gitlab-wf
skill-type: workflow
memory-file: workflow/manage-gitlab-wf.md
description: Handles all GitLab and local git operations for the current repository using the git and glab CLIs. Every action is presented for user confirmation before execution. Activated by manage-git-wf; also invoke directly for GitLab-specific operations.
...
| File | Load when |
|---|---|
| `subflows/manage-gitlab-mr-sf.md` | User wants to create, review, merge, or close an MR |
| `subflows/manage-gitlab-pipeline-sf.md` | User wants to trigger, monitor, retry, or cancel a pipeline |
